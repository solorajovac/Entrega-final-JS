function compraTotal(productosDelStorage) {
    ...
    if(acumulador == 0) {
        ...
        modalBody.innerHTML = "<p>No hay productos agregados.</p>" 
    } else {
...
function cargarProductosModal(productosDelStorage) {
    ...
    productosDelStorage.forEach((productoCarrito, indice) => {
        ...
        modalBody.innerHTML += `
            <div class="card border-danger mb-3" id ="productoCarrito${indice}" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="./img/${productoCarrito.img}" class="img-fluid rounded-start mt-5" alt="...">
                </div>
            <div class="col-md-8">
                <div class="card-body">
                ...
                <div class="row">
                    <p class="card-text">Peso: ${productoCarrito.peso}</p>
...
botonFinalizarCompra.addEventListener('click', () => {
    ...
    swal("¡Gracias por su compra!", "Los productos seran enviados a la brevedad", "success");
})